...
interface InputProps {
  ...
  value?: string; // ✅ penting: supaya value bisa dikontrol dari React state
  required?: boolean;
  readOnly?: boolean;
}
...
if (type !== "date" && type !== "time") {
  ...
  // Tambahkan style berdasarkan state
  if (disabled) {
  ...
  return (
    <div className="relative">
      <input
        ...
        value={value} // ✅ tambahkan agar bisa dikontrol
        onChange={onChange}
        min={min}
        max={max}
        step={step}
        disabled={disabled}
        readOnly={readOnly}
        required={required} // ✅ tambahkan biar ikut form validation
