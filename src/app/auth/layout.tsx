...
export default function AuthLayout({
  ...
  const appLogo = ENVIRONMENT_SYSTEM.appLogo;
  const appName = ENVIRONMENT_SYSTEM.appName || "Financial Extraktor";
          ...
          <div className="relative flex lg:flex-row w-full h-screen justify-center flex-col">
            ...
            <div className="lg:w-1/2 w-full h-full lg:flex lg:items-center lg:justify-center hidden relative">
              <div
                ...
                style={{ background: `linear-gradient(105deg, #2e2e2e)` }}
              >
                <GridShape />
              </div>
              ...
              <div className="relative z-10 flex flex-col items-center text-center px-6">
                <div className="mb-3 p-2 bg-white dark:bg-gray-800 rounded-full shadow-lg">
                  <Image width={150} height={100} src={appLogo} alt={appName} />
                </div>
